...
<body> 
    ...
    <div class="col-sm-10"><div class="col-xs-4">
		<input type="text" value="<?php echo $name ?>" name="name" class="form-control" id="name" placeholder="Введите имя студента" pattern="^[ А-я-A-z]+$" title="Только буквы" required>
    </div></div>
	  
	<label class="control-label col-sm-2" for="lastname">Фамилия:*</label>
    <div class="col-sm-10"><div class="col-xs-4">
		<input type="text" value="<?php echo $lastname ?>" name="lastname" class="form-control" id="lastname" placeholder="Введите фамилию" pattern="^[ А-я-A-z]+$" title="Только буквы" required>
    </div></div>
    ...
    <div class="col-sm-10"><div class="col-xs-4">
		<input type="text" value="<?php echo $age ?>" name="age" class="form-control" id="age" placeholder="Введите возраст" pattern="^[ 0-9]+$" title="Только цифры" required>
      </div></div>
	  
	<label class="control-label col-sm-2" for="gruppa">Группа:*</label>
    <div class="col-sm-10"><div class="col-xs-4">
		<input type="text" value="<?php echo $group ?>" name="gruppa" class="form-control" id="gruppa" placeholder="Введите группу" required>
    </div></div>
	  
	<label class="control-label col-sm-2" for="faculty">Факультет:*</label>
    <div class="col-sm-10"><div class="col-xs-4">
		<input type="text" value="<?php echo $faculty ?>" name="faculty" class="form-control" id="faculty" placeholder="Введите факультет" pattern="^[ А-я-A-z]+$" title="Только буквы" required>
    </div></div>
	</div>
